...
function applyDefaults(){
  ...
  gc.h={
    ...
    events:[
      ...
      {year:'03',title:'125', unit:'日',     text:'年間休日'},
      {year:'04',title:'10',  unit:'%+',     text:'昇給率'},
      {year:'05',title:'70',  unit:'%',      text:'リモート率'},
  ...
  gc.ceo={
    ...
    paragraphs:[
      ...
      'トライテックでは、リモートワークや副業の推奨、年間125日の休日など、柔軟な働き方を実現しながらも、昇給率10%以上を目標とした年次給与改定など、公正かつ透明な評価制度を整えています。',
